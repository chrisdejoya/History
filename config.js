...
export const ICONS = {
    ...
    'LB': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#808080"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="16" font-weight="bold" fill="black">LB</text></svg>',
    'RB': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#808080"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="16" font-weight="bold" fill="black">RB</text></svg>',
    'LT': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#696969"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="16" font-weight="bold" fill="black">LT</text></svg>',
    'RT': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#696969"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="16" font-weight="bold" fill="black">RT</text></svg>',
