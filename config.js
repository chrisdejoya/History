...
export const ICONS = {
    ...
    // Buttons
    'A': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#32CD32"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="20" font-weight="bold" fill="black" stroke="black" stroke-width="1.2">A</text></svg>',
    'B': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#DC143C"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="20" font-weight="bold" fill="black" stroke="black" stroke-width="1.2">B</text></svg>',
    'X': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#4169E1"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="20" font-weight="bold" fill="black" stroke="black" stroke-width="1.2">X</text></svg>',
    'Y': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#FFD700"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="20" font-weight="bold" fill="black" stroke="black" stroke-width="1.2">Y</text></svg>',
    'LB': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#808080"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="18" font-weight="bold" fill="black" stroke="black" stroke-width="1.2">LB</text></svg>',
    'RB': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#808080"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="18" font-weight="bold" fill="black" stroke="black" stroke-width="1.2">RB</text></svg>',
    'LT': '<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#696969"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-size="18" font-weight="bold" fill="black" stroke="black" stroke-width="1.2">LT</text></svg>',
